...
def myFormPost():
    ...
    return render_template('index2.html', plot=bar, plot2=line, tweets=tweets, scorecard=scorecard, map=map, tables=[tweets.to_html(classes='data')], titles=tweets.columns.values)
